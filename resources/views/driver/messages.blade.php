                                    ...
                                    <ul class="users">
                                        ...
                                        <?php
                                            if (Request::is('dashboard/messages/*') AND count($chats) == 0) {
                                                ?>
                                                <li class="person Delivered" data-chat="person1" onclick="location.href='{{ route('messagepassenger', ['id'=> $user->id ]) }}';">
                                                    <div class="user">
                                        ...
                                        @if(count($messages) > 0)
                                            ...
                                            @php
                                                $passenger = App\Models\User::where('id', $message->passenger_id)->select('name', 'profile_picture')->first();
                                            @endphp

                                                <li class="person {{ $message->status }}" data-chat="person1" onclick="location.href='{{ route('messagepassenger', ['id'=> $message->passenger_id ]) }}';">
                                                    <div class="user">
                                                        <img src="{{ $passenger->profile_picture }}" class="img-thumbnail">
                                                    </div>
                                                    <p class="name-time">
                                                        <span class="name">
                                                            {{ substr($passenger->name, 0, 10) }}...
                                                        </span>
                                                    </p>
                                                </li>
                                            @endforeach
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9 mobileCHatBox">
                                <div class="chat-container">
                                    ...
                                    @if(isset($chats))
                                        ...
                                        <?php
                                            if (Request::is('driver-dashboard/messages/*')) {
                                                ?>
                                                <div class="row">
                                                    <div class="col-md-4 offset-md-4 text-center">
                                                        <img src="{{ $passenger->profile_picture }}" class="img-thumbnail" style="width: 70px;">
                                                        <p style="font-size: 10px;">{{ $passenger->name }}</p>
                                                    </div>
                                                </div>
                                                <?php       
                                            }
                                        ...
                                        @foreach($chats as $chat)
                                            ...
                                            @else
                                                <li class="chat-left">
                                                    <div class="chat-avatar">
                                                        <img src="{{ $passenger->profile_picture }}" alt="Retail Admin">
                                                        <span class="d-flex" style="font-size: 10px;">{{ $passenger->name }}</span>
                                                    </div>
                                        ...
                                        <input type="hidden" id="driver_id" value="<?php echo session('user_id'); ?>">
                                        <input type="hidden" id="passenger_id" value="<?php echo $passenger_id; ?>">
                                        ...
                                        <div class="form-group mt-3 mb-0">
                                            <input id="sendMessageFrmDriver" type="text" placeholder="Type your message here..." class="form-control">
                                        </div>
                                    @else
                                        <div class="row pt-5">
